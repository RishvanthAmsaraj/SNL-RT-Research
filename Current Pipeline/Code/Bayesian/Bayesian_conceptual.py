...
Produces six annotated DDM schematics (per measure x speed) from group-mean
Bayesian fits, matching the original conceptual figure style.

Outputs: ddm_hrt_{speed}_degs.pdf/.png, ddm_srt_{speed}_degs.pdf/.png
